                        ...
                        <div class="c-pricing__top">
                            ...
                            <div class="w-form">
                                <form id="email-form" name="email-form" data-name="Email Form">
                                    <input type="submit" value="Download" data-wait="Please wait..." class="button-primary is-fullwidth w-button">
                                </form>
                ...
                <div class="c-pricing h100 margin-bottom-double">
                    <div class="c-pricing__inner h100 flexv-space-between">
                        <div class="c-pricing__top">
                            ...
                            <div class="w-form">
                                <form id="email-form" name="email-form" data-name="Email Form">
                                    <input type="submit" value="Connect" data-wait="Please wait..." class="button-primary is-fullwidth w-button">
                                </form>
                                <div class="success-message w-form-done">
                                    <div>Thank you! Your submission has been received!</div>
                                </div>
                ...
                <div class="c-pricing h100 margin-bottom-double">
                    <div class="c-pricing__inner h100 flexv-space-between">
                        <div class="c-pricing__top">
                            ...
                            <div class="w-form">
                                <form id="email-form" name="email-form" data-name="Email Form">
                                    <input type="submit" value="Coming soon.." data-wait="Please wait..." class="button-primary is-fullwidth w-button" disabled>
                                </form>
                                <div class="success-message w-form-done">
                                    <div>Thank you! Your submission has been received!</div>
                                </div>

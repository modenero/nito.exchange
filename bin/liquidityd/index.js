...
console.log('\nStarting CashShuffle Liqudity Daemon...')

/**

The purpose of this daemon is to provide liqudity to the various tiers
of the CashShuffle network:
...
Tier #4         0.1          $30.00 ✓
Tier #5         1.0         $300.00 ✓
Tier #6        10.0       $3,000.00 ✓
Tier #7       100.0      $30,000.00 𝒙
Tier #8     1,000.0     $300,000.00 𝒙


- up to 2 liqudity daemons can be run at a time
...
;(async () => {
    ...
    /* Set txid. */
    const txid = pledges[0].previousTransactionHash
    console.log('UPDATE STATUS (txid)', txid)

    /* Set vout. */
    const vout = pledges[0].previousOutputIndex
